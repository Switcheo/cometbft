...
import (
	...
	oracle "github.com/cometbft/cometbft/proto/tendermint/oracle"
...
type ResponseValidateOracleVotes_Status int32

const (
	ResponseValidateOracleVotes_ABSENT  ResponseValidateOracleVotes_Status = 0
	ResponseValidateOracleVotes_PRESENT ResponseValidateOracleVotes_Status = 1
)

var ResponseValidateOracleVotes_Status_name = map[int32]string{
	0: "ABSENT",
	1: "PRESENT",
}

var ResponseValidateOracleVotes_Status_value = map[string]int32{
	"ABSENT":  0,
	"PRESENT": 1,
}

func (x ResponseValidateOracleVotes_Status) String() string {
	return proto.EnumName(ResponseValidateOracleVotes_Status_name, int32(x))
}

func (ResponseValidateOracleVotes_Status) EnumDescriptor() ([]byte, []int) {
...
type Request struct {
	...
	//	*Request_CreateOracleResultTx
	//	*Request_FetchOracleVotes
	//	*Request_ValidateOracleVotes
	//	*Request_DoesOracleResultExist
...
type Request_CreateOracleResultTx struct {
	CreateOracleResultTx *RequestCreateOracleResultTx `protobuf:"bytes,21,opt,name=create_oracle_result_tx,json=createOracleResultTx,proto3,oneof" json:"create_oracle_result_tx,omitempty"`
}
type Request_FetchOracleVotes struct {
	FetchOracleVotes *RequestFetchOracleVotes `protobuf:"bytes,22,opt,name=fetch_oracle_votes,json=fetchOracleVotes,proto3,oneof" json:"fetch_oracle_votes,omitempty"`
}
type Request_ValidateOracleVotes struct {
	ValidateOracleVotes *RequestValidateOracleVotes `protobuf:"bytes,23,opt,name=validate_oracle_votes,json=validateOracleVotes,proto3,oneof" json:"validate_oracle_votes,omitempty"`
}
type Request_DoesOracleResultExist struct {
	DoesOracleResultExist *RequestDoesOracleResultExist `protobuf:"bytes,24,opt,name=does_oracle_result_exist,json=doesOracleResultExist,proto3,oneof" json:"does_oracle_result_exist,omitempty"`
}
type Request_DoesSubaccountBelongToVal struct {
	DoesSubaccountBelongToVal *RequestDoesSubaccountBelongToVal `protobuf:"bytes,25,opt,name=does_subaccount_belong_to_val,json=doesSubaccountBelongToVal,proto3,oneof" json:"does_subaccount_belong_to_val,omitempty"`
}
...
func (*Request_CreateOracleResultTx) isRequest_Value()      {}
func (*Request_FetchOracleVotes) isRequest_Value()          {}
func (*Request_ValidateOracleVotes) isRequest_Value()       {}
func (*Request_DoesOracleResultExist) isRequest_Value()     {}
...
func (m *Request) GetCreateOracleResultTx() *RequestCreateOracleResultTx {
	if x, ok := m.GetValue().(*Request_CreateOracleResultTx); ok {
		return x.CreateOracleResultTx
	}
	return nil
}

func (m *Request) GetFetchOracleVotes() *RequestFetchOracleVotes {
	if x, ok := m.GetValue().(*Request_FetchOracleVotes); ok {
		return x.FetchOracleVotes
	}
	return nil
}

func (m *Request) GetValidateOracleVotes() *RequestValidateOracleVotes {
	if x, ok := m.GetValue().(*Request_ValidateOracleVotes); ok {
		return x.ValidateOracleVotes
	}
	return nil
}

func (m *Request) GetDoesOracleResultExist() *RequestDoesOracleResultExist {
	if x, ok := m.GetValue().(*Request_DoesOracleResultExist); ok {
		return x.DoesOracleResultExist
	}
	return nil
}

func (m *Request) GetDoesSubaccountBelongToVal() *RequestDoesSubaccountBelongToVal {
	if x, ok := m.GetValue().(*Request_DoesSubaccountBelongToVal); ok {
		return x.DoesSubaccountBelongToVal
	}
	return nil
}
...
func (*Request) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Request_CreateOracleResultTx)(nil),
		(*Request_FetchOracleVotes)(nil),
		(*Request_ValidateOracleVotes)(nil),
		(*Request_DoesOracleResultExist)(nil),
		(*Request_DoesSubaccountBelongToVal)(nil),
	}
}
...
type RequestCreateOracleResultTx struct {
	Proposer      []byte                  `protobuf:"bytes,1,opt,name=proposer,proto3" json:"proposer,omitempty"`
	GossipedVotes []*oracle.GossipedVotes `protobuf:"bytes,2,rep,name=gossiped_votes,json=gossipedVotes,proto3" json:"gossiped_votes,omitempty"`
}

func (m *RequestCreateOracleResultTx) Reset()         { *m = RequestCreateOracleResultTx{} }
func (m *RequestCreateOracleResultTx) String() string { return proto.CompactTextString(m) }
func (*RequestCreateOracleResultTx) ProtoMessage()    {}
func (*RequestCreateOracleResultTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{17}
}
func (m *RequestCreateOracleResultTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestCreateOracleResultTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestCreateOracleResultTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestCreateOracleResultTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestCreateOracleResultTx.Merge(m, src)
}
func (m *RequestCreateOracleResultTx) XXX_Size() int {
	return m.Size()
}
func (m *RequestCreateOracleResultTx) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestCreateOracleResultTx.DiscardUnknown(m)
}

var xxx_messageInfo_RequestCreateOracleResultTx proto.InternalMessageInfo

func (m *RequestCreateOracleResultTx) GetProposer() []byte {
	if m != nil {
		return m.Proposer
	}
	return nil
...
func (m *RequestCreateOracleResultTx) GetGossipedVotes() []*oracle.GossipedVotes {
	if m != nil {
...
type RequestFetchOracleVotes struct {
}

func (m *RequestFetchOracleVotes) Reset()         { *m = RequestFetchOracleVotes{} }
func (m *RequestFetchOracleVotes) String() string { return proto.CompactTextString(m) }
func (*RequestFetchOracleVotes) ProtoMessage()    {}
func (*RequestFetchOracleVotes) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{18}
}
func (m *RequestFetchOracleVotes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestFetchOracleVotes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestFetchOracleVotes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestFetchOracleVotes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestFetchOracleVotes.Merge(m, src)
}
func (m *RequestFetchOracleVotes) XXX_Size() int {
	return m.Size()
}
func (m *RequestFetchOracleVotes) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestFetchOracleVotes.DiscardUnknown(m)
}

var xxx_messageInfo_RequestFetchOracleVotes proto.InternalMessageInfo

type RequestValidateOracleVotes struct {
	OracleTx []byte `protobuf:"bytes,1,opt,name=oracle_tx,json=oracleTx,proto3" json:"oracle_tx,omitempty"`
}

func (m *RequestValidateOracleVotes) Reset()         { *m = RequestValidateOracleVotes{} }
func (m *RequestValidateOracleVotes) String() string { return proto.CompactTextString(m) }
func (*RequestValidateOracleVotes) ProtoMessage()    {}
func (*RequestValidateOracleVotes) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{19}
}
func (m *RequestValidateOracleVotes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestValidateOracleVotes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestValidateOracleVotes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestValidateOracleVotes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestValidateOracleVotes.Merge(m, src)
}
func (m *RequestValidateOracleVotes) XXX_Size() int {
	return m.Size()
}
func (m *RequestValidateOracleVotes) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestValidateOracleVotes.DiscardUnknown(m)
}

var xxx_messageInfo_RequestValidateOracleVotes proto.InternalMessageInfo

func (m *RequestValidateOracleVotes) GetOracleTx() []byte {
	if m != nil {
		return m.OracleTx
	}
	return nil
...
type RequestDoesOracleResultExist struct {
	Key string `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
}

func (m *RequestDoesOracleResultExist) Reset()         { *m = RequestDoesOracleResultExist{} }
func (m *RequestDoesOracleResultExist) String() string { return proto.CompactTextString(m) }
func (*RequestDoesOracleResultExist) ProtoMessage()    {}
func (*RequestDoesOracleResultExist) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{20}
}
func (m *RequestDoesOracleResultExist) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestDoesOracleResultExist) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestDoesOracleResultExist.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestDoesOracleResultExist) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestDoesOracleResultExist.Merge(m, src)
}
func (m *RequestDoesOracleResultExist) XXX_Size() int {
	return m.Size()
}
func (m *RequestDoesOracleResultExist) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestDoesOracleResultExist.DiscardUnknown(m)
}

var xxx_messageInfo_RequestDoesOracleResultExist proto.InternalMessageInfo

func (m *RequestDoesOracleResultExist) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
type RequestDoesSubaccountBelongToVal struct {
	Address []byte `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
}

func (m *RequestDoesSubaccountBelongToVal) Reset()         { *m = RequestDoesSubaccountBelongToVal{} }
func (m *RequestDoesSubaccountBelongToVal) String() string { return proto.CompactTextString(m) }
func (*RequestDoesSubaccountBelongToVal) ProtoMessage()    {}
func (*RequestDoesSubaccountBelongToVal) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{21}
}
func (m *RequestDoesSubaccountBelongToVal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestDoesSubaccountBelongToVal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestDoesSubaccountBelongToVal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestDoesSubaccountBelongToVal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestDoesSubaccountBelongToVal.Merge(m, src)
}
func (m *RequestDoesSubaccountBelongToVal) XXX_Size() int {
	return m.Size()
}
func (m *RequestDoesSubaccountBelongToVal) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestDoesSubaccountBelongToVal.DiscardUnknown(m)
}

var xxx_messageInfo_RequestDoesSubaccountBelongToVal proto.InternalMessageInfo

func (m *RequestDoesSubaccountBelongToVal) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
type Response struct {
	...
	//	*Response_ValidateOracleVotes
	//	*Response_DoesOracleResultExist
...
type Response_CreateOracleResultTx struct {
	CreateOracleResultTx *ResponseCreateOracleResultTx `protobuf:"bytes,22,opt,name=create_oracle_result_tx,json=createOracleResultTx,proto3,oneof" json:"create_oracle_result_tx,omitempty"`
}
type Response_FetchOracleVotes struct {
	FetchOracleVotes *ResponseFetchOracleVotes `protobuf:"bytes,23,opt,name=fetch_oracle_votes,json=fetchOracleVotes,proto3,oneof" json:"fetch_oracle_votes,omitempty"`
}
type Response_ValidateOracleVotes struct {
	ValidateOracleVotes *ResponseValidateOracleVotes `protobuf:"bytes,24,opt,name=validate_oracle_votes,json=validateOracleVotes,proto3,oneof" json:"validate_oracle_votes,omitempty"`
}
type Response_DoesOracleResultExist struct {
	DoesOracleResultExist *ResponseDoesOracleResultExist `protobuf:"bytes,25,opt,name=does_oracle_result_exist,json=doesOracleResultExist,proto3,oneof" json:"does_oracle_result_exist,omitempty"`
}
type Response_DoesSubaccountBelongToVal struct {
	DoesSubaccountBelongToVal *ResponseDoesSubaccountBelongToVal `protobuf:"bytes,26,opt,name=does_subaccount_belong_to_val,json=doesSubaccountBelongToVal,proto3,oneof" json:"does_subaccount_belong_to_val,omitempty"`
}
...
func (*Response_CreateOracleResultTx) isResponse_Value()      {}
func (*Response_FetchOracleVotes) isResponse_Value()          {}
func (*Response_ValidateOracleVotes) isResponse_Value()       {}
func (*Response_DoesOracleResultExist) isResponse_Value()     {}
func (*Response_DoesSubaccountBelongToVal) isResponse_Value() {}
...
func (m *Response) GetCreateOracleResultTx() *ResponseCreateOracleResultTx {
	if x, ok := m.GetValue().(*Response_CreateOracleResultTx); ok {
		return x.CreateOracleResultTx
	}
	return nil
}

func (m *Response) GetFetchOracleVotes() *ResponseFetchOracleVotes {
	if x, ok := m.GetValue().(*Response_FetchOracleVotes); ok {
		return x.FetchOracleVotes
	}
	return nil
}

func (m *Response) GetValidateOracleVotes() *ResponseValidateOracleVotes {
	if x, ok := m.GetValue().(*Response_ValidateOracleVotes); ok {
		return x.ValidateOracleVotes
	}
	return nil
}

func (m *Response) GetDoesOracleResultExist() *ResponseDoesOracleResultExist {
	if x, ok := m.GetValue().(*Response_DoesOracleResultExist); ok {
		return x.DoesOracleResultExist
	}
	return nil
}
...
func (m *Response) GetDoesSubaccountBelongToVal() *ResponseDoesSubaccountBelongToVal {
	if x, ok := m.GetValue().(*Response_DoesSubaccountBelongToVal); ok {
		return x.DoesSubaccountBelongToVal
	}
	return nil
}
...
func (*Response) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Response_CreateOracleResultTx)(nil),
		(*Response_FetchOracleVotes)(nil),
		(*Response_ValidateOracleVotes)(nil),
		(*Response_DoesOracleResultExist)(nil),
		(*Response_DoesSubaccountBelongToVal)(nil),
	}
}
...
type ResponseCreateOracleResultTx struct {
	EncodedTx []byte `protobuf:"bytes,1,opt,name=encoded_tx,json=encodedTx,proto3" json:"encoded_tx,omitempty"`
}

func (m *ResponseCreateOracleResultTx) Reset()         { *m = ResponseCreateOracleResultTx{} }
func (m *ResponseCreateOracleResultTx) String() string { return proto.CompactTextString(m) }
func (*ResponseCreateOracleResultTx) ProtoMessage()    {}
func (*ResponseCreateOracleResultTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{40}
}
func (m *ResponseCreateOracleResultTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseCreateOracleResultTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseCreateOracleResultTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseCreateOracleResultTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseCreateOracleResultTx.Merge(m, src)
}
func (m *ResponseCreateOracleResultTx) XXX_Size() int {
	return m.Size()
}
func (m *ResponseCreateOracleResultTx) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseCreateOracleResultTx.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseCreateOracleResultTx proto.InternalMessageInfo

func (m *ResponseCreateOracleResultTx) GetEncodedTx() []byte {
	if m != nil {
		return m.EncodedTx
	}
	return nil
...
type ResponseFetchOracleVotes struct {
	Vote *oracle.Vote `protobuf:"bytes,1,opt,name=vote,proto3" json:"vote,omitempty"`
}

func (m *ResponseFetchOracleVotes) Reset()         { *m = ResponseFetchOracleVotes{} }
func (m *ResponseFetchOracleVotes) String() string { return proto.CompactTextString(m) }
func (*ResponseFetchOracleVotes) ProtoMessage()    {}
func (*ResponseFetchOracleVotes) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{41}
}
func (m *ResponseFetchOracleVotes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseFetchOracleVotes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseFetchOracleVotes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseFetchOracleVotes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseFetchOracleVotes.Merge(m, src)
}
func (m *ResponseFetchOracleVotes) XXX_Size() int {
	return m.Size()
}
func (m *ResponseFetchOracleVotes) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseFetchOracleVotes.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseFetchOracleVotes proto.InternalMessageInfo

func (m *ResponseFetchOracleVotes) GetVote() *oracle.Vote {
	if m != nil {
		return m.Vote
	}
	return nil
...
type ResponseValidateOracleVotes struct {
	Status ResponseValidateOracleVotes_Status `protobuf:"varint,1,opt,name=status,proto3,enum=tendermint.abci.ResponseValidateOracleVotes_Status" json:"status,omitempty"`
}

func (m *ResponseValidateOracleVotes) Reset()         { *m = ResponseValidateOracleVotes{} }
func (m *ResponseValidateOracleVotes) String() string { return proto.CompactTextString(m) }
func (*ResponseValidateOracleVotes) ProtoMessage()    {}
func (*ResponseValidateOracleVotes) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{42}
}
func (m *ResponseValidateOracleVotes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseValidateOracleVotes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseValidateOracleVotes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseValidateOracleVotes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseValidateOracleVotes.Merge(m, src)
}
func (m *ResponseValidateOracleVotes) XXX_Size() int {
	return m.Size()
}
func (m *ResponseValidateOracleVotes) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseValidateOracleVotes.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseValidateOracleVotes proto.InternalMessageInfo

func (m *ResponseValidateOracleVotes) GetStatus() ResponseValidateOracleVotes_Status {
	if m != nil {
		return m.Status
	}
	return ResponseValidateOracleVotes_ABSENT
}

type ResponseDoesOracleResultExist struct {
	DoesExist bool `protobuf:"varint,1,opt,name=does_exist,json=doesExist,proto3" json:"does_exist,omitempty"`
}

func (m *ResponseDoesOracleResultExist) Reset()         { *m = ResponseDoesOracleResultExist{} }
func (m *ResponseDoesOracleResultExist) String() string { return proto.CompactTextString(m) }
func (*ResponseDoesOracleResultExist) ProtoMessage()    {}
func (*ResponseDoesOracleResultExist) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{43}
}
func (m *ResponseDoesOracleResultExist) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseDoesOracleResultExist) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseDoesOracleResultExist.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseDoesOracleResultExist) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseDoesOracleResultExist.Merge(m, src)
}
func (m *ResponseDoesOracleResultExist) XXX_Size() int {
	return m.Size()
}
func (m *ResponseDoesOracleResultExist) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseDoesOracleResultExist.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseDoesOracleResultExist proto.InternalMessageInfo

func (m *ResponseDoesOracleResultExist) GetDoesExist() bool {
	if m != nil {
		return m.DoesExist
	}
	return false
...
type ResponseDoesSubaccountBelongToVal struct {
	BelongsToVal bool   `protobuf:"varint,1,opt,name=belongs_to_val,json=belongsToVal,proto3" json:"belongs_to_val,omitempty"`
	ValAddress   string `protobuf:"bytes,2,opt,name=val_address,json=valAddress,proto3" json:"val_address,omitempty"`
}

func (m *ResponseDoesSubaccountBelongToVal) Reset()         { *m = ResponseDoesSubaccountBelongToVal{} }
func (m *ResponseDoesSubaccountBelongToVal) String() string { return proto.CompactTextString(m) }
func (*ResponseDoesSubaccountBelongToVal) ProtoMessage()    {}
func (*ResponseDoesSubaccountBelongToVal) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{44}
}
func (m *ResponseDoesSubaccountBelongToVal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseDoesSubaccountBelongToVal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseDoesSubaccountBelongToVal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseDoesSubaccountBelongToVal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseDoesSubaccountBelongToVal.Merge(m, src)
}
func (m *ResponseDoesSubaccountBelongToVal) XXX_Size() int {
	return m.Size()
}
func (m *ResponseDoesSubaccountBelongToVal) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseDoesSubaccountBelongToVal.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseDoesSubaccountBelongToVal proto.InternalMessageInfo

func (m *ResponseDoesSubaccountBelongToVal) GetBelongsToVal() bool {
	if m != nil {
...
func (m *ResponseDoesSubaccountBelongToVal) GetValAddress() string {
	if m != nil {
		return m.ValAddress
	}
	return ""
...
func init() {
	...
	proto.RegisterEnum("tendermint.abci.ResponseValidateOracleVotes_Status", ResponseValidateOracleVotes_Status_name, ResponseValidateOracleVotes_Status_value)
	...
	proto.RegisterType((*RequestCreateOracleResultTx)(nil), "tendermint.abci.RequestCreateOracleResultTx")
	proto.RegisterType((*RequestFetchOracleVotes)(nil), "tendermint.abci.RequestFetchOracleVotes")
	proto.RegisterType((*RequestValidateOracleVotes)(nil), "tendermint.abci.RequestValidateOracleVotes")
	proto.RegisterType((*RequestDoesOracleResultExist)(nil), "tendermint.abci.RequestDoesOracleResultExist")
	proto.RegisterType((*RequestDoesSubaccountBelongToVal)(nil), "tendermint.abci.RequestDoesSubaccountBelongToVal")
	...
	proto.RegisterType((*ResponseCreateOracleResultTx)(nil), "tendermint.abci.ResponseCreateOracleResultTx")
	proto.RegisterType((*ResponseFetchOracleVotes)(nil), "tendermint.abci.ResponseFetchOracleVotes")
	proto.RegisterType((*ResponseValidateOracleVotes)(nil), "tendermint.abci.ResponseValidateOracleVotes")
	proto.RegisterType((*ResponseDoesOracleResultExist)(nil), "tendermint.abci.ResponseDoesOracleResultExist")
	proto.RegisterType((*ResponseDoesSubaccountBelongToVal)(nil), "tendermint.abci.ResponseDoesSubaccountBelongToVal")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	// 3700 bytes of a gzipped FileDescriptorProto
	,
}
...
type ABCIClient interface {
	...
	CreateOracleResultTx(ctx context.Context, in *RequestCreateOracleResultTx, opts ...grpc.CallOption) (*ResponseCreateOracleResultTx, error)
	FetchOracleVotes(ctx context.Context, in *RequestFetchOracleVotes, opts ...grpc.CallOption) (*ResponseFetchOracleVotes, error)
	ValidateOracleVotes(ctx context.Context, in *RequestValidateOracleVotes, opts ...grpc.CallOption) (*ResponseValidateOracleVotes, error)
	DoesOracleResultExist(ctx context.Context, in *RequestDoesOracleResultExist, opts ...grpc.CallOption) (*ResponseDoesOracleResultExist, error)
	DoesSubaccountBelongToVal(ctx context.Context, in *RequestDoesSubaccountBelongToVal, opts ...grpc.CallOption) (*ResponseDoesSubaccountBelongToVal, error)
}
...
func (c *aBCIClient) CreateOracleResultTx(ctx context.Context, in *RequestCreateOracleResultTx, opts ...grpc.CallOption) (*ResponseCreateOracleResultTx, error) {
	out := new(ResponseCreateOracleResultTx)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/CreateOracleResultTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) FetchOracleVotes(ctx context.Context, in *RequestFetchOracleVotes, opts ...grpc.CallOption) (*ResponseFetchOracleVotes, error) {
	out := new(ResponseFetchOracleVotes)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/FetchOracleVotes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) ValidateOracleVotes(ctx context.Context, in *RequestValidateOracleVotes, opts ...grpc.CallOption) (*ResponseValidateOracleVotes, error) {
	out := new(ResponseValidateOracleVotes)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/ValidateOracleVotes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) DoesOracleResultExist(ctx context.Context, in *RequestDoesOracleResultExist, opts ...grpc.CallOption) (*ResponseDoesOracleResultExist, error) {
	out := new(ResponseDoesOracleResultExist)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/DoesOracleResultExist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) DoesSubaccountBelongToVal(ctx context.Context, in *RequestDoesSubaccountBelongToVal, opts ...grpc.CallOption) (*ResponseDoesSubaccountBelongToVal, error) {
	out := new(ResponseDoesSubaccountBelongToVal)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/DoesSubaccountBelongToVal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedABCIServer) CreateOracleResultTx(ctx context.Context, req *RequestCreateOracleResultTx) (*ResponseCreateOracleResultTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateOracleResultTx not implemented")
}
func (*UnimplementedABCIServer) FetchOracleVotes(ctx context.Context, req *RequestFetchOracleVotes) (*ResponseFetchOracleVotes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchOracleVotes not implemented")
}
func (*UnimplementedABCIServer) ValidateOracleVotes(ctx context.Context, req *RequestValidateOracleVotes) (*ResponseValidateOracleVotes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidateOracleVotes not implemented")
}
func (*UnimplementedABCIServer) DoesOracleResultExist(ctx context.Context, req *RequestDoesOracleResultExist) (*ResponseDoesOracleResultExist, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DoesOracleResultExist not implemented")
}
func (*UnimplementedABCIServer) DoesSubaccountBelongToVal(ctx context.Context, req *RequestDoesSubaccountBelongToVal) (*ResponseDoesSubaccountBelongToVal, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DoesSubaccountBelongToVal not implemented")
}
...
func _ABCI_CreateOracleResultTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestCreateOracleResultTx)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).CreateOracleResultTx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/CreateOracleResultTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).CreateOracleResultTx(ctx, req.(*RequestCreateOracleResultTx))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCI_FetchOracleVotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestFetchOracleVotes)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).FetchOracleVotes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/FetchOracleVotes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).FetchOracleVotes(ctx, req.(*RequestFetchOracleVotes))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCI_ValidateOracleVotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestValidateOracleVotes)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).ValidateOracleVotes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/ValidateOracleVotes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).ValidateOracleVotes(ctx, req.(*RequestValidateOracleVotes))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCI_DoesOracleResultExist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestDoesOracleResultExist)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).DoesOracleResultExist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/DoesOracleResultExist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).DoesOracleResultExist(ctx, req.(*RequestDoesOracleResultExist))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCI_DoesSubaccountBelongToVal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestDoesSubaccountBelongToVal)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).DoesSubaccountBelongToVal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/DoesSubaccountBelongToVal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ABCI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateOracleResultTx",
			Handler:    _ABCI_CreateOracleResultTx_Handler,
		},
		{
			MethodName: "FetchOracleVotes",
			Handler:    _ABCI_FetchOracleVotes_Handler,
		},
		{
			MethodName: "ValidateOracleVotes",
			Handler:    _ABCI_ValidateOracleVotes_Handler,
		},
		{
			MethodName: "DoesOracleResultExist",
			Handler:    _ABCI_DoesOracleResultExist_Handler,
		},
		{
			MethodName: "DoesSubaccountBelongToVal",
			Handler:    _ABCI_DoesSubaccountBelongToVal_Handler,
		},
	},
...
func (m *Request_CreateOracleResultTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_CreateOracleResultTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CreateOracleResultTx != nil {
		{
			size, err := m.CreateOracleResultTx.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Request_FetchOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_FetchOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FetchOracleVotes != nil {
		{
			size, err := m.FetchOracleVotes.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Request_ValidateOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_ValidateOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ValidateOracleVotes != nil {
		{
			size, err := m.ValidateOracleVotes.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Request_DoesOracleResultExist) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_DoesOracleResultExist) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DoesOracleResultExist != nil {
		{
			size, err := m.DoesOracleResultExist.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Request_DoesSubaccountBelongToVal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_DoesSubaccountBelongToVal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DoesSubaccountBelongToVal != nil {
		{
			size, err := m.DoesSubaccountBelongToVal.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestExtendVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n30, err30 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.Time, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.Time):])
	if err30 != nil {
		return 0, err30
	}
	i -= n30
...
func (m *RequestCreateOracleResultTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestCreateOracleResultTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestCreateOracleResultTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.GossipedVotes) > 0 {
		for iNdEx := len(m.GossipedVotes) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.GossipedVotes[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *RequestFetchOracleVotes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestFetchOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestFetchOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RequestValidateOracleVotes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestValidateOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestValidateOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.OracleTx) > 0 {
		i -= len(m.OracleTx)
		copy(dAtA[i:], m.OracleTx)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.OracleTx)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RequestDoesOracleResultExist) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestDoesOracleResultExist) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestDoesOracleResultExist) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RequestDoesSubaccountBelongToVal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestDoesSubaccountBelongToVal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestDoesSubaccountBelongToVal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_CreateOracleResultTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_CreateOracleResultTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CreateOracleResultTx != nil {
		{
			size, err := m.CreateOracleResultTx.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Response_FetchOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_FetchOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FetchOracleVotes != nil {
		{
			size, err := m.FetchOracleVotes.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Response_ValidateOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_ValidateOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ValidateOracleVotes != nil {
		{
			size, err := m.ValidateOracleVotes.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Response_DoesOracleResultExist) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_DoesOracleResultExist) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DoesOracleResultExist != nil {
		{
			size, err := m.DoesOracleResultExist.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Response_DoesSubaccountBelongToVal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_DoesSubaccountBelongToVal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DoesSubaccountBelongToVal != nil {
		{
			size, err := m.DoesSubaccountBelongToVal.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseApplySnapshotChunk) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RefetchChunks) > 0 {
		dAtA58 := make([]byte, len(m.RefetchChunks)*10)
		var j57 int
		...
		i = encodeVarintTypes(dAtA, i, uint64(j57))
		i--
		dAtA[i] = 0x12
	}
	if m.Result != 0 {
...
func (m *ResponseCreateOracleResultTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseCreateOracleResultTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseCreateOracleResultTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EncodedTx) > 0 {
		i -= len(m.EncodedTx)
		copy(dAtA[i:], m.EncodedTx)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.EncodedTx)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ResponseFetchOracleVotes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseFetchOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseFetchOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseValidateOracleVotes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseValidateOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseValidateOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseDoesOracleResultExist) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseDoesOracleResultExist) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseDoesOracleResultExist) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseDoesSubaccountBelongToVal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseDoesSubaccountBelongToVal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseDoesSubaccountBelongToVal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Misbehavior) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n65, err65 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.Time, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.Time):])
	if err65 != nil {
		return 0, err65
	}
	i -= n65
...
func (m *Request_CreateOracleResultTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CreateOracleResultTx != nil {
		l = m.CreateOracleResultTx.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Request_FetchOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.FetchOracleVotes != nil {
		l = m.FetchOracleVotes.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Request_ValidateOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ValidateOracleVotes != nil {
		l = m.ValidateOracleVotes.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Request_DoesOracleResultExist) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DoesOracleResultExist != nil {
		l = m.DoesOracleResultExist.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Request_DoesSubaccountBelongToVal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DoesSubaccountBelongToVal != nil {
		l = m.DoesSubaccountBelongToVal.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *RequestCreateOracleResultTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestFetchOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestValidateOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestDoesOracleResultExist) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestDoesSubaccountBelongToVal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_CreateOracleResultTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_FetchOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_ValidateOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_DoesOracleResultExist) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_DoesSubaccountBelongToVal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseCreateOracleResultTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseFetchOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseValidateOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseDoesOracleResultExist) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseDoesSubaccountBelongToVal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreateOracleResultTx", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestCreateOracleResultTx{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_CreateOracleResultTx{v}
			iNdEx = postIndex
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FetchOracleVotes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestFetchOracleVotes{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_FetchOracleVotes{v}
			iNdEx = postIndex
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidateOracleVotes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestValidateOracleVotes{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_ValidateOracleVotes{v}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DoesOracleResultExist", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestDoesOracleResultExist{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_DoesOracleResultExist{v}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DoesSubaccountBelongToVal", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestDoesSubaccountBelongToVal{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_DoesSubaccountBelongToVal{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RequestCreateOracleResultTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestCreateOracleResultTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestCreateOracleResultTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GossipedVotes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.GossipedVotes = append(m.GossipedVotes, &oracle.GossipedVotes{})
			if err := m.GossipedVotes[len(m.GossipedVotes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RequestFetchOracleVotes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestFetchOracleVotes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestFetchOracleVotes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *RequestValidateOracleVotes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestValidateOracleVotes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestValidateOracleVotes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OracleTx", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OracleTx = append(m.OracleTx[:0], dAtA[iNdEx:postIndex]...)
			if m.OracleTx == nil {
				m.OracleTx = []byte{}
			}
			iNdEx = postIndex
...
func (m *RequestDoesOracleResultExist) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestDoesOracleResultExist: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestDoesOracleResultExist: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestDoesSubaccountBelongToVal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestDoesSubaccountBelongToVal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestDoesSubaccountBelongToVal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			...
			v := &ResponseCreateOracleResultTx{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_CreateOracleResultTx{v}
			iNdEx = postIndex
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FetchOracleVotes", wireType)
			...
			v := &ResponseFetchOracleVotes{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_FetchOracleVotes{v}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidateOracleVotes", wireType)
			...
			v := &ResponseValidateOracleVotes{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_ValidateOracleVotes{v}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DoesOracleResultExist", wireType)
			...
			v := &ResponseDoesOracleResultExist{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_DoesOracleResultExist{v}
			iNdEx = postIndex
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DoesSubaccountBelongToVal", wireType)
			...
			v := &ResponseDoesSubaccountBelongToVal{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_DoesSubaccountBelongToVal{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ResponseCreateOracleResultTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseCreateOracleResultTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseCreateOracleResultTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncodedTx", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncodedTx = append(m.EncodedTx[:0], dAtA[iNdEx:postIndex]...)
			if m.EncodedTx == nil {
				m.EncodedTx = []byte{}
			}
			iNdEx = postIndex
...
func (m *ResponseFetchOracleVotes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseFetchOracleVotes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseFetchOracleVotes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ResponseValidateOracleVotes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseValidateOracleVotes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseValidateOracleVotes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= ResponseValidateOracleVotes_Status(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ResponseDoesOracleResultExist) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseDoesOracleResultExist: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseDoesOracleResultExist: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DoesExist", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ResponseDoesSubaccountBelongToVal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseDoesSubaccountBelongToVal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseDoesSubaccountBelongToVal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BelongsToVal", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
